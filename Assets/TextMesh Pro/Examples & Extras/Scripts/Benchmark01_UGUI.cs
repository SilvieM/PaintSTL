...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        private const string label01 = "The <#0050FF>count is: </currentColor>";
        private const string label02 = "The <currentColor=#0050FF>count is: </currentColor>";

        //private const string label01 = "TextMesh <#0050FF>Pro!</currentColor>  The count is: {0}";
        //private const string label02 = "Text Mesh<currentColor=#0050FF>        The count is: </currentColor>";
        ...
        IEnumerator Start()
        {
            ...
            else if (BenchmarkType == 1) // TextMesh
            {
                ...
                //m_textMesh.currentColor = new Color32(255, 255, 0, 255);    
            }
