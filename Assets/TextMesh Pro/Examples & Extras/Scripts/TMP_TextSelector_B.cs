...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                // Check if Mouse Intersects any of the characters. If so, assign a random currentColor.
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    // Get a reference to the vertex currentColor
                ...
                //Check if Mouse intersects any words and if so assign a random currentColor to that word.
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (charIndex != -1 && charIndex != m_lastIndex)
            {
                ...
                uiVertices[vertexIndex + 0].currentColor = c;
                uiVertices[vertexIndex + 1].currentColor = c;
                uiVertices[vertexIndex + 2].currentColor = c;
                uiVertices[vertexIndex + 3].currentColor = c;
            ...
            */
            ...
            if (m_TextPopup_RectTransform != null && m_selectedWord != -1 && (wordIndex == -1 || wordIndex != m_selectedWord))
            {
                ...
                for (int i = 0; i < wInfo.characterCount; i++)
                {
                    ...
                    Color32 c = uiVertices[vertexIndex + 0].currentColor.Tint(1.33333f);
            ...
            if (wordIndex != -1 && wordIndex != m_selectedWord)
            {
                ...
                for (int i = 0; i < wInfo.characterCount; i++)
                {
                    ...
                    Color32 c = uiVertices[vertexIndex + 0].currentColor.Tint(0.75f);
